...
LevelDefinition makeLevel4() {
    return {
        ...
        {
            wave({{0.0f, EnemyKind::Subject, 0},
                  {2.0f, EnemyKind::Subject, 1},
                  {4.0f, EnemyKind::Research, 0},
                  {6.0f, EnemyKind::Social, 1},
                  {8.0f, EnemyKind::MorningClass, 0},
                  {10.0f, EnemyKind::Research, 1},
                  {12.0f, EnemyKind::Subject, 0}}, 80),
            wave({{0.0f, EnemyKind::GroupProject, 1},
                  {1.8f, EnemyKind::Research, 1},
                  {3.6f, EnemyKind::ExamSyllabus, 0},
                  {5.4f, EnemyKind::PeerPressure, 1},
                  {7.2f, EnemyKind::ShortVideo, 0},
                  {9.0f, EnemyKind::Research, 1},
                  {10.8f, EnemyKind::ExamSyllabus, 0},
                  {12.6f, EnemyKind::PeerPressure, 1},
                  {14.4f, EnemyKind::GroupProject, 0},
                  {16.2f, EnemyKind::ShortVideo, 1}}, 135),
            wave({{0.0f, EnemyKind::MidtermBoss, 0},
                  {1.8f, EnemyKind::GroupProject, 1},
                  {3.6f, EnemyKind::ExamSyllabus, 0},
                  {5.4f, EnemyKind::PeerPressure, 1},
                  {7.2f, EnemyKind::ShortVideo, 0},
                  {9.0f, EnemyKind::GroupProject, 1},
                  {10.8f, EnemyKind::ExamSyllabus, 0},
                  {12.6f, EnemyKind::PeerPressure, 1},
                  {14.4f, EnemyKind::ShortVideo, 0},
                  {16.2f, EnemyKind::GroupProject, 1},
                  {18.0f, EnemyKind::MidtermBoss, 0}}, 250),
        },
    };
}
