    ...
    return {
        ...
        }},
        {
            ...
            wave({{0.0f, EnemyKind::Subject, 0},
                  ...
                  {8.0f, EnemyKind::MorningClass, 0}}, 80),
            wave({{0.0f, EnemyKind::Subject, 0},
                  {2.0f, EnemyKind::MorningClass, 0},
                  {5.0f, EnemyKind::Social, 0},
                  {8.0f, EnemyKind::MidtermBoss, 0}}, 150),
        },
    };
}
